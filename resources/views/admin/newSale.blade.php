    ...
    @if (count($invoice_settings) > 0)
        @if ($invoice_settings[0]->end_range - $invoice_settings[0]->invoices + 1 > 0)
            @if ($invoice_settings[0]->invoice_header != null)
                ...
                <div class="form-payment">
                    <div class="header-clients">
                        ...
                        <div class="pay_way-options">
                            ...
                            <div class="">
                                <label for="pay_way_dolars">Dolares ({{ $invoice_settings[0]->dolar_change }}
                                    Lps)</label>
                ...
                <div class="newSale-container">
                    ...
                    <div class="actions-container">
                        <input type="hidden" name="" id="invoice_setting"
                            value="{{ $invoice_settings[0]->id }}">
                        <h3>Hora:</h3>
            ...
            @else
                ...
                <p>Se requiere que configure el encabezado de factura previamente para realizar una venta o acción
                    similar.</p>
            @endif
        @else
            <h1>limite de facturas fue alcanzado</h1>
            <p>Se requiere que actualice el rango de impresión de facturas.</p>
        @endif
    @else
        <h1>Factura no configurada</h1>
